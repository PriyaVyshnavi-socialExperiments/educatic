...
import { AssignmentUploadPageRoutingModule } from './assignment-upload-routing.module';
...
@NgModule({
  imports: [
    ...
    AssignmentUploadPageRoutingModule
  ],
  declarations: [AssignmentUploadPage],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class AssignmentUploadPageModule {}
